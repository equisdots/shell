...
Item {
   ...
   // -------------------------------------------------------------------------
    ...
    readonly property string scriptsDir: Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/ui/panels/focustime"
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        ColumnLayout {
                                            ...
                                            Item {
                                                Layout.fillWidth: true
                                                height: window.s(10)
                                                Rectangle { anchors.fill: parent; radius: window.s(7); color: window.crust }
                                                Rectangle {
