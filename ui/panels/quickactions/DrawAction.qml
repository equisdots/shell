...
import "../../../core" // Imports Caching.qml from the parent quickshell directory
    ...
    Item {
        ...
        Row {
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Item {
                        ...
                        Rectangle {
                            anchors.fill: parent; radius: s(18); z:-1
            ...
            Rectangle {
                ...
                Rectangle {
                    anchors.centerIn: parent; width: s(32); height: s(32); radius: s(18); z:-1
