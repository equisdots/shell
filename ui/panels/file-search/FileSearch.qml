...
Item {
    ...
    function startSearch() {
        ...
        searcher.command = ["bash", Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/ui/panels/file-search/fetch.sh", window.searchQuery.trim()]
        searcher.running = false
        searcher.running = true
    }
Timer { id: searchTimer; interval: Personalization.value("file-search", Config.rawSettings["file-search"], "debounceMs"); onTriggered: startSearch() }
