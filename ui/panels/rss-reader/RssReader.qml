...
Item {
    ...
    Process {
        ...
        command: ["python3", Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/ui/panels/rss-reader/fetch.py"]
...
Timer { interval: Personalization.value("rss-reader", Config.rawSettings["rss-reader"], "refreshMs"); running: true; repeat: true; triggeredOnStart: false; onTriggered: { fetcher.running = false; fetcher.running = true } }
