    ...
    delegate: Component {
        PanelWindow {
            ...
            property var tabModules: [
                "panels/quickactions/DrawAction.qml",
		"panels/quickactions/SystemUsage.qml",
		"panels/quickactions/Timer.qml"
            ]
		...
		if (!floatingWidget.isSidebarVisible) return Qt.rect(0, 0, 0, 0);
            ...
            mask: Region {
                ...
                Region {
                    x: floatingWidget.isPeekVisible ? peekBar.x - floatingWidget.s(18) : 0
                    y: floatingWidget.isPeekVisible ? peekBar.y - floatingWidget.s(18) : 0
            ...
            Rectangle {
                ...
                width: floatingWidget.activeEdge === "bottom" ? Math.max(floatingWidget.s(20), floatingWidget.baseSidebarH - floatingWidget.s(20)) : floatingWidget.s(15)
                ...
                property real visualDragOffset: {
                    ...
                    return Math.max(-floatingWidget.s(18), Math.min(peekMouse.currentDragDelta, floatingWidget.s(18))); 
                }
                ...
                MouseArea {
                    id: peekMouse
                    anchors.fill: parent
                    anchors.margins: -floatingWidget.s(18) 
                    hoverEnabled: true
                    ...
                    onPositionChanged: mouse => {
                        ...
                        if (delta > floatingWidget.s(18) && !floatingWidget.isExpanded) {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            id: sidebarDragArea
                            anchors.fill: parent
                            anchors.margins: floatingWidget.isExpanded ? -floatingWidget.s(60) : -floatingWidget.s(18) 
                            hoverEnabled: true
                    ...
                    Item {
                        ...
                        Item {
                            anchors.fill: parent
                            anchors.topMargin: floatingWidget.s(18)
                            anchors.bottomMargin: floatingWidget.s(18)
                            anchors.leftMargin: floatingWidget.s(18)
                            anchors.rightMargin: floatingWidget.s(18)
                        ...
                        Item {
                            ...
                            Item {
                                ...
                                Item {
                                    ...
                                    y: floatingWidget.activeEdge === "left"
                                        ? floatingWidget.s(9)
                                        : parent.height - height - floatingWidget.s(9)
                                    ...
                                    color: floatingWidget.isPinned
                                        ...
                                        : (pinMouse.pressed
                                            ...
                                            : (pinMouse.containsMouse
                                                ...
                                                : "transparent"))
                                    border.width: floatingWidget.s(5)
