...
Item {
    ...
    function activate(index) {
        ...
        // Las páginas del grupo Bar/Bar (colapsable) no están en
        // navForEngine() cuando el grupo está cerrado y gotoPage las
        // ignoraría: expandirlo antes de navegar.
        if (page.indexOf("d_") === 0 && root.bar.barGroupExpanded === false)
            root.bar.barGroupExpanded = true;
        bar.gotoPage(page);
        jumpTimer.mode = mode;
        jumpTimer.page = page;
    ...
    function pageLabel(id) {
        ...
        case "d_classic": return "Classic Bar";
