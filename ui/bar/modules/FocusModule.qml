...
//
// Data comes from the bar's 1s watcher on `hyprctl activewindow -j`
...
//
// Compact (vertical bar): icon only, so it stays readable at pill width.
// ============================================================================
