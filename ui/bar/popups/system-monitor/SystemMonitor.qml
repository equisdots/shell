...
Item {
    ...
    readonly property int historyLen: Personalization.value("system-monitor", Config.rawSettings["system-monitor"], "historyLength")
    ...
    Timer { interval: Personalization.value("system-monitor", Config.rawSettings["system-monitor"], "pollMs"); running: true; repeat: true; triggeredOnStart: false; onTriggered: { runner.running = false; runner.running = true } }
                ...
                Rectangle { Layout.fillWidth: true; Layout.preferredHeight: s(78); radius: s(10); color: window.crust; clip: true
                    ...
                    RowLayout { anchors.fill: parent; anchors.margins: s(12); spacing: s(10)
                        Rectangle { Layout.preferredWidth: s(36); Layout.preferredHeight: s(36); radius: s(10); color: Qt.rgba(window.blue.r, window.blue.g, window.blue.b, 0.15)
                            Text { anchors.centerIn: parent; text: "\uF0351"; font.family: "Hack Nerd Font"; font.pixelSize: s(16); color: window.blue } }
                        ColumnLayout { Layout.fillWidth: true; spacing: s(2)
