...
Item {
    ...
    function applyPresetOptimistically(presetName) {
        ...
        if (presets[presetName]) {
            ...
            execCmd(`$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/equalizer.sh preset ${presetName}`);
        }
    }
    ...
    Process {
        id: musicProc
        running: true
        command: ["bash", "-c", "$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/music_info.sh"]
    ...
    Process {
        id: eqProc
        running: true
        command: ["bash", "-c", "$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/equalizer.sh get"]
        stdout: StdioCollector {
            onStreamFinished: {
                if (this.text) {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        anchors.centerIn: parent
                                        spacing: root.s(6)
                                        Text { text: root.musicData.deviceIcon || "󰓃"; color: root.mauve; font.family: "Hack Nerd Font"; font.pixelSize: root.s(14) }
                                        Text { text: root.musicData.deviceName || "Speaker"; color: root.overlay2; font.family: "Hack Nerd Font"; font.pixelSize: root.s(12); font.bold: true }
                                    }
                                }
                                Text {
                        ...
                        ColumnLayout {
                            ...
                            Slider {
                                ...
                                onPressedChanged: {
                                    if (pressed) {
                                        ...
                                        root.execCmd(`$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/player_control.sh seek ${value.toFixed(2)} ${root.musicData.length} "${safePlayer}"`);
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Text { text: root.musicData.positionStr || "00:00"; color: root.overlay2; font.family: "Hack Nerd Font"; font.bold: true; font.pixelSize: root.s(13) }
                                Item { Layout.fillWidth: true }
                                Text { text: root.musicData.lengthStr || "00:00"; color: root.overlay2; font.family: "Hack Nerd Font"; font.bold: true; font.pixelSize: root.s(13) }
                            }
                        }
                        ...
                        RowLayout {
                            ...
                            MouseArea {
                                ...
                                Text { anchors.centerIn: parent; text: ""; color: parent.pressed ? root.text : root.overlay2; font.family: "Hack Nerd Font"; font.pixelSize: root.s(24) }
                            }
                            MouseArea {
                                id: playPauseBtn
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text { text: "Equalizer"; color: root.mauve; font.family: "Hack Nerd Font"; font.pixelSize: root.s(16); font.bold: true; Layout.fillWidth: true }
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    if (root.eqData.pending) {
                                        ...
                                        root.triggerEqLightning();
                                        root.execCmd("$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/equalizer.sh apply");
                                    }
                                }
                            }
                        }
                        Text { text: root.eqData.preset || "Flat"; color: root.subtext0; font.family: "Hack Nerd Font"; font.pixelSize: root.s(14); font.bold: true; Layout.leftMargin: root.s(15) }
                    }
                                        ...
                                        Slider {
                                            ...
                                            onPressedChanged: {
                                                if (!pressed) {
                                                    ...
                                                    root.execCmd(`$HOME/.config/hypr/scripts/quickshell/ui/bar/popups/music/equalizer.sh set_band ${modelData.idx} ${Math.round(value)}`);
                                                }
                                            }
                                            ...
                                            background: Rectangle {
                                                ...
                                                Rectangle {
                                                    ...
                                                    radius: parent.radius + root.s(13) + sliderDelegate.ringPulse * root.s(20)
                                                    color: "transparent"
