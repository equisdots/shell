...
Item {
    ...
    // STATE & CONFIG
    // -------------------------------------------------------------------------
    readonly property string scriptsDir: Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/ui/bar/popups/volume"
    ...
    Timer { id: syncDelay; interval: Personalization.value("volume", Config.rawSettings["volume"], "syncDelayMs"); onTriggered: { window.draggingNodes = ({}); window.draggingMaster = false; } }
                        ...
                        ColumnLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "Hack Nerd Font"; font.weight: Font.Black; font.pixelSize: window.s(20)
                                    color: window.text
                            ...
                            RowLayout {
                                ...
                                Item {
                                    ...
                                    Rectangle {
                                        anchors.fill: parent; radius: window.s(16)
                    ...
                    ListView {
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                anchors.centerIn: parent
                                spacing: window.s(10)
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "Hack Nerd Font"; font.pixelSize: window.s(32); color: window.surface2; text: "󰖁" }
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "Hack Nerd Font"; font.pixelSize: window.s(14); color: window.overlay0; text: "No active streams" }
                            }
                        }
                        ...
                        delegate: Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        font.family: "Hack Nerd Font"; font.pixelSize: window.s(22)
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        Layout.preferredWidth: window.s(32); Layout.preferredHeight: window.s(32); radius: window.s(21)
