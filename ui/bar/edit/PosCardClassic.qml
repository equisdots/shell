...
// Selector de posición del editor CLASSIC (Fase 4: familia GuidePopup).
...
Rectangle {
    ...
    readonly property bool isActive: card.bar && card.bar.classic && String(card.bar.classic.position) === card.pos
