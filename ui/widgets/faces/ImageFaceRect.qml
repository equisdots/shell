...
// ============================================================================
// ImageFaceRect — plain rectangular image frame.
// Accepts the image through any of wImagePath / imagePath / path (the Widget
// window binds all three); shows a placeholder until a valid file is set.
// ============================================================================
