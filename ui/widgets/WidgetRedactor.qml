...
Item {
    ...
    property int sw: Personalization.value("widgets", Config.rawSettings.widgets, "redactorWidth")
    property int sh: Personalization.value("widgets", Config.rawSettings.widgets, "redactorHeight")
