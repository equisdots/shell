...
Item {
    ...
    // Grupo "Desktop" (6 tabs compartidas de settings) + grupo "Bar / Bar"
    ...
    property var navGroups: [
        ...
        { id: "barbar", label: "Bar / Bar", expandable: true, items: [
    ...
    // El grupo Bar/Bar arranca expandido; cambiar de engine NO lo colapsa.
    property bool barGroupExpanded: true
    ...
    function navForEngine() {
        ...
        for (let i = 0; i < root.navGroups.length; i++) {
            ...
            if (g.expandable && !root.barGroupExpanded) continue;
                            ...
                            Column {
                                ...
                                Item {
                                    ...
                                    Text {
                                        ...
                                        font.pixelSize: s(12)
                                        color: colors.subtext0
                                        rotation: root.barGroupExpanded ? 0 : -90
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            root.barGroupExpanded = !root.barGroupExpanded;
                                            Qt.callLater(root.syncNavPill);
                                        }
                                    }
                                }
                                Item {
                                    id: barItemsWrap
                                    width: parent.width
                                    height: barCol.height
                                    visible: root.barGroupExpanded

                                    // Línea de rail (estilo Classicantium) para los subtabs.
                                    Rectangle {
                                        x: s(6)
                                        width: s(2)
                                        radius: s(1)
                                    ...
                                    Column {
                                        ...
                                        Repeater {
                                            ...
                                            delegate: NavItem {
                                                ...
                                                active: root.currentPage === modelData.id
                                                onActivated: root.gotoPage(modelData.id)
                                                Component.onCompleted: { root.navItemMap[navRowBar.pageId] = navRowBar; root.syncNavPill(); }
                                                Component.onDestruction: delete root.navItemMap[navRowBar.pageId]
                                                onYChanged: if (root.currentPage === modelData.id) root.syncNavPill()
                                            }
                                        }
                                    }
