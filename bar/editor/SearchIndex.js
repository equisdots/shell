...
// ── Entradas de las páginas del editor (grupo Bar/Bar + System). ──
// y = offset aproximado de scroll en px lógicos (0 = arriba / desconocido).
// Iconos: copiados de las páginas reales (bar/editor/*.qml) o de los navGroups
...
function pageEntries() {
    return [
        ...
        { page: "d_launcher", label: "Avoid bar",         desc: "Keep the launcher clear of the bar/bar", icon: "󰀻", color: "blue",    y: 716 },
        ...
        { page: "d_engine",     label: "Engine",     desc: "Bar or Serpantinum bar",          icon: "󰮯", color: "mauve",    y: 0 },
        ...
        { page: "d_zones",      label: "Zones",      desc: "Bar zones and modules",           icon: "󰮯", color: "sapphire", y: 0 },
        { page: "d_workspaces", label: "Workspaces", desc: "Empty workspace marker",           icon: "󰠰", color: "teal",     y: 0 },
        { page: "d_classic",       label: "Classic Bar",   desc: "Classic bar sections and actions", icon: "󰹑", color: "mauve",    y: 0 }
    ];
}
