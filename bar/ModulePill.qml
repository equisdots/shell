...
// ============================================================================
// ModulePill — the shared island pill every bar module is built from.
//
...
//   • compact mode: in a vertical bar the pill becomes a narrow vertical
...
Item {
    ...
    // Flat-mode icon tinting (bar.accentTintMode, classic solid/fill styles):
